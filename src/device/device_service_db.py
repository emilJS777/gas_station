...
def create_device(key: str, name: str, description: str, client_id: int) -> Device:
    device: Device = Device(key=key, name=name, client_id=client_id, description=description)
    device.save_db()
    return device
